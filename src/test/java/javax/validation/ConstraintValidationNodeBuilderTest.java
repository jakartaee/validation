...
public class ConstraintValidationNodeBuilderTest {
	...
	public void testParameterNode() throws Exception {
		...
		// on createUser(String password, String passwordRepeat)
		...
		// on createUser(Map<String,Address> user, Map<String,Address> otherUser)
		context.buildConstraintViolationWithTemplate("Map entry home address does not match")
		            .addParameterNode(1)
		            .addBeanNode()
		                .inIterable().atKey("home")
		            .addConstraintViolation();
		...
		// on createUser(Map<String,Address> user, Map<String,Address> otherUser)
		context.buildConstraintViolationWithTemplate("Map entry home address city does not match")
		            .addParameterNode(1)
